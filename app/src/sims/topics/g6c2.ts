...
const SOLID_LIQUID_GAS: ArchetypeSpec = {
  ...
  specimens: [
    { id: "ice", name: "Ice at -10 degrees", category: "solid",
      ...
      art: { art: "sphere", color: "#dfeaf5", radius: 0.46 } },
    ...
    { id: "steam", name: "Steam at 110 degrees", category: "gas",
      because: "Molecules fly apart at hundreds of metres a second. The same mass of water takes about 1 600 times more space.",
    ...
    { id: "air", name: "The air in this room", category: "gas",
      ...
      art: { art: "sphere", color: "#cfe0ee", radius: 0.5, glow: 0.4 } },
