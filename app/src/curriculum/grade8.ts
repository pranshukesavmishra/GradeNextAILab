      ...
      topics: [
        {
          ...
          subtopics: [
            { code: "A1.1", title: "Distance vs displacement", sims: ["phys.motion-graphs"] },
            { code: "A1.2", title: "Speed vs velocity", sims: ["phys.motion-graphs"] },
            { code: "A1.3", title: "Reading a position-time graph", sims: ["phys.motion-graphs"] },
            { code: "A1.4", title: "Reference frames", sims: ["phys.motion-graphs"] },
            { code: "A1.5", title: "Calculating average speed", sims: ["phys.motion-graphs"] },
          ],
        },
        {
          code: "A2", title: "Acceleration and motion graphs", standards: ["MS-PS2-2"],
          subtopics: [
            { code: "A2.1", title: "Acceleration as a rate of change", sims: ["phys.motion-graphs"] },
            { code: "A2.2", title: "Reading a velocity-time graph", sims: ["phys.motion-graphs"] },
            { code: "A2.3", title: "Constant vs changing acceleration", sims: ["phys.motion-graphs"] },
            { code: "A2.4", title: "Deceleration", sims: ["phys.motion-graphs"] },
            { code: "A2.5", title: "Connecting the two graph types", sims: ["phys.motion-graphs"] },
          ],
        },
        {
          code: "A3", title: "Newton's First Law", standards: ["MS-PS2-1"],
          subtopics: [
            { code: "A3.1", title: "Inertia", sims: ["phys.forces"] },
            { code: "A3.2", title: "Balanced vs unbalanced forces", sims: ["phys.forces"] },
            { code: "A3.3", title: "Free-body diagrams", sims: ["phys.forces"] },
            { code: "A3.4", title: "Friction as the reason intuition misleads", sims: ["phys.forces"] },
            { code: "A3.5", title: "Applying the First Law to everyday scenarios", sims: ["phys.forces"] },
          ],
        },
        {
          code: "A4", title: "Forces, mass and change in motion", standards: ["MS-PS2-2"],
          subtopics: [
            { code: "A4.1", title: "Planning a fair test of force and motion", sims: ["phys.forces"] },
            { code: "A4.2", title: "The qualitative force-mass-acceleration relationship", sims: ["phys.forces"] },
            { code: "A4.3", title: "Running the investigation", sims: ["phys.forces"] },
            { code: "A4.4", title: "Comparing prediction to measured data", sims: ["phys.forces"] },
            { code: "A4.5", title: "Communicating investigation results", sims: ["phys.forces"] },
          ],
        },
        {
          code: "A5", title: "Newton's Third Law and collisions", standards: ["MS-PS2-1"],
          subtopics: [
            { code: "A5.1", title: "Action-reaction pairs", sims: ["phys.collisions"] },
            { code: "A5.2", title: "Why the pair acts on different objects", sims: ["phys.collisions"] },
            { code: "A5.3", title: "A common Third Law misconception", sims: ["phys.collisions"] },
            { code: "A5.4", title: "Applying the law to a collision-safety design", sims: ["phys.collisions"] },
            { code: "A5.5", title: "Testing the design against criteria", sims: ["phys.collisions"] },
          ],
        },
        {
          ...
          subtopics: [
            { code: "A6.1", title: "Defining criteria and constraints", sims: ["phys.collisions"] },
            { code: "A6.2", title: "Crumple zones and impulse, conceptually", sims: ["phys.collisions"] },
            { code: "A6.3", title: "Generating candidate solutions", sims: ["phys.collisions"] },
            { code: "A6.4", title: "Systematic evaluation of designs", sims: ["phys.collisions"] },
            { code: "A6.5", title: "Reporting the best solution and its trade-offs", sims: ["phys.collisions"] },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          subtopics: [
            { code: "B1.1", title: "Kinetic energy and mass", sims: ["phys.kinetic-energy"] },
            { code: "B1.2", title: "Kinetic energy and speed", sims: ["phys.kinetic-energy"] },
            { code: "B1.3", title: "Why speed has the larger effect", sims: ["phys.kinetic-energy"] },
            { code: "B1.4", title: "Interpreting the shape of the curve", sims: ["phys.kinetic-energy"] },
            { code: "B1.5", title: "Applying kinetic energy to a collision scenario", sims: ["phys.collisions"] },
          ],
        },
        {
          code: "B2", title: "Potential energy in a system", standards: ["MS-PS3-2"],
          subtopics: [
            { code: "B2.1", title: "Gravitational potential energy", sims: ["phys.energy-skate"] },
            { code: "B2.2", title: "Elastic potential energy", sims: ["phys.energy-skate"] },
            { code: "B2.3", title: "Potential energy as a property of a system", sims: ["phys.energy-skate"] },
            { code: "B2.4", title: "Modeling potential energy as an arrangement changes", sims: ["phys.energy-skate"] },
            { code: "B2.5", title: "Potential and kinetic energy trading off", sims: ["phys.energy-skate", "phys.pendulum"] },
          ],
        },
        {
          code: "B3", title: "Energy transfer in a collision", standards: ["MS-PS3-2"],
          subtopics: [
            { code: "B3.1", title: "Energy converted, not lost", sims: ["phys.collisions"] },
            { code: "B3.2", title: "Elastic vs inelastic collisions", sims: ["phys.collisions"] },
            { code: "B3.3", title: "Tracing energy through a crash", sims: ["phys.collisions"] },
            { code: "B3.4", title: "Safety design and energy conversion", sims: ["phys.collisions"] },
            { code: "B3.5", title: "Comparing energy conversion across two collisions", sims: ["phys.collisions"] },
          ],
        },
        {
          code: "B4", title: "Energy conservation across a system", standards: ["MS-PS3-2"],
          subtopics: [
            { code: "B4.1", title: "Energy is conserved", sims: ["phys.energy-skate"] },
            { code: "B4.2", title: "Tracking energy through a multi-step system", sims: ["phys.energy-skate"] },
            { code: "B4.3", title: "Dissipation as spreading out, not disappearing", sims: ["phys.energy-skate", "phys.heat-transfer"] },
            { code: "B4.4", title: "Applying conservation to a bouncing ball", sims: ["phys.energy-skate"] },
            { code: "B4.5", title: "Conservation as a check on a claim", sims: ["phys.energy-skate"] },
          ],
        },
        {
          code: "B5", title: "Modeling and iterative testing", standards: ["MS-ETS1-4"],
          subtopics: [
            { code: "B5.1", title: "Developing a model to generate data", sims: ["phys.collisions"] },
            { code: "B5.2", title: "Running a first round of testing", sims: ["phys.collisions"] },
            { code: "B5.3", title: "Modifying the model from test data", sims: ["phys.collisions"] },
            { code: "B5.4", title: "Naming the trade-off in each improvement", sims: ["phys.collisions"] },
            { code: "B5.5", title: "A second round of modification", sims: ["phys.collisions"] },
          ],
        },
      ],
    },
